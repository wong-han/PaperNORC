...
traj_counter = 0
# 修改散点样式
ax2_1.scatter(0, 0, marker='o', s=15, c='r', zorder=3)
fig2.legend(loc=(0.095, 0.902), ncols=2, frameon=False)

fig2.savefig('image/optimal_data_SOP_NoSTM.pdf', bbox_inches='tight', pad_inches=0.1)
for count in range(100):
    x10, x20 = np.random.uniform(-0.1, 0.1, size=2)
